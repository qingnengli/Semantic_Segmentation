...
def change_label(label_url, label_name):
    ...
    save_path = '/home/amax/SIAT/Data-PASCALVOC/Label'
    save_path = os.path.join(save_path, label_name)  # 确定保存路径及名称
    label_single.save(save_path)


val_file_path = '/home/amax/SIAT/Data-PASCALVOC/ImageSets/Segmentation/trainval.txt'  # 文件名存放路径
label_file_path = '/home/amax/SIAT/Data-PASCALVOC/SegmentationClass'  # 原label存放路径
